...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/idees.css') }}" />
    <script type="text/javascript" src="{{ URL::asset('js/idees.js') }}"></script>
    <title>Idées innovantes</title>
</head>
          ...
          <div class="col-right">
            ...
            <div id="all_data">
              ...
              <table class="idea_table">
                ...
                <tr>
                  <td colspan="3" class="like"><button class="like_button">j'aime l'idée </button></td>
                </tr>
            </table>
            @endforeach
            </div>
