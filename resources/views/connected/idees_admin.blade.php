...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/idees_admin.css') }}" />
    <script type="text/javascript" src="{{ URL::asset('js/idees_admin.js') }}"></script>
    <title>Idées</title>
</head>
    ...
    <section id="about">
        <div class="about container">
          <div class="col-right">
            ...
            <h1 class="section-title" style="text-align: center;">Idées <span>Innovantes</span></h1><br><br><br>
              <div id="all_data">
